...
})({"8JSDW":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "798f1fa5b120c3e5";
"use strict";
...
function handleImageDetails(image, { imageSrc, imageTitle, imageContent, imageSource, imageFilesize, imageDownload, formatSpan, filesizeSpan, engineSpan, previewImg }) {
    const resultsContainer = (0, _utils.$)("#results");
...
function setupImages(resultsContainer) {
    const imageSrc = (0, _utils.$)("#image-src");
    const previewImg = (0, _utils.$)("#preview-img");
    const imageTitle = (0, _utils.$)("#image-title");
    const imageContent = (0, _utils.$)("#image-content");
    const imageFormat = (0, _utils.$)("#image-format");
    const imageFilesize = (0, _utils.$)("#image-filesize");
    const imageSource = (0, _utils.$)("#image-source");
    const imageDownload = (0, _utils.$)("#image-download");
    const imageCopy = (0, _utils.$)("#image-copy");
    ...
    const engineSpan = (0, _utils.$)("#image-engine");
    const ImagesObserver = new MutationObserver((mutationsList)=>{
        for (const mutation of mutationsList)if (mutation.type === "childList") mutation.addedNodes.forEach((element)=>{
            if (!(element instanceof HTMLElement)) return;
            if (element.classList.contains("images_group")) element.childNodes.forEach((node)=>node.addEventListener("click", (e)=>{
                    e.preventDefault();
                    removePrvImageClass();
    ...
    const bodyContainer = (0, _utils.$)("#results");
    const imageDetailsContainer = (0, _utils.$)("#image-details");
...
},{"./utils":"hKc06","debounce":"i6VK1","@parcel/transformer-js/src/esmodule-helpers.js":"4HWzX"}],"hKc06":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"i6VK1":[function(require,module,exports,__globalThis) {
...
},{}]},["8JSDW","jxVSe"], "jxVSe", "parcelRequire94c2")
